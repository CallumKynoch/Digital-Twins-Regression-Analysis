...
def perform_linear_regression_and_plot():
    ...
    # Add a column of ones for the intercept
    x = sm.add_constant(np.column_stack((x1_values, x2_values, x1_squared, x2_squared)))
